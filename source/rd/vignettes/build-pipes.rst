...
.. note:: This is especially useful for genomics pipelines since not every step is the same in terms of resources it uses. And being able to tune them, makes the setup quite effecient.
